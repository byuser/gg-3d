...
import { ZONE_BY_ID } from "../data/zones.js";
  ...
  const LOCALES = {
    en: {
      ...
      // ---- travelling vendors (Task 40): searchable map-target names ----
      "vendor.merchant": "Travelling Merchant",
      "vendor.blacksmith": "Blacksmith",
      "vendor.apothecary": "Apothecary",
      ...
      "map.kind.zone": "Land", "map.kind.location": "Landmark", "map.kind.npc": "Person", "map.kind.vendor": "Vendor",
    ...
    ru: {
      ...
      // ---- travelling vendors (Task 40): searchable map-target names ----
      "vendor.merchant": "Странствующий торговец",
      "vendor.blacksmith": "Кузнец",
      "vendor.apothecary": "Аптекарь",
      ...
      "map.kind.zone": "Край", "map.kind.location": "Место", "map.kind.npc": "Персонаж", "map.kind.vendor": "Лавка",
